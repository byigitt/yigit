    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="Alert when Claude Code or Codex running in a terminal needs your input or finishes. Desktop notification when yigit is unfocused, in-app otherwise."
        >
          <Switch
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <SettingRow
            ...
            description="Open yigit automatically when you sign in."
          >
            <Switch
              checked={autostart}
          ...
          <SettingRow
            ...
            description="Reopen the tabs, splits, and active working directories from your last session."
          >
            <Switch
